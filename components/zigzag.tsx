...
import FeatImage01 from '@/public/images/coming_soon.png'
import FeatImage02 from '@/public/images/coming_soon.png'
import FeatImage03 from '@/public/images/coming_soon.png'
import FeatImage04 from '@/public/images/coming_soon.png'
    ...
    <section>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          {/* Section header */}<div className="inline-flex text-sm font-semibold py-1 px-3 m-2 text-green-600 bg-green-200 rounded-full mb-4">Reach goals that matter</div>
              ...
              <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-right">
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  ...
                  <ul className="text-lg text-gray-400 -mb-2">
                    ...
                    <li className='inline-flex text-sm font-semibold py-1 px-3 m-2 text-green-600 bg-green-200 rounded-full mb-4'><a href="/"> Try for Free!</a></li>
                  </ul>
                </div>
              </div>
